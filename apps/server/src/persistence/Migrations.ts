...
import Migration0030 from "./Migrations/030_ProjectionTurnsCheckpointCaptureState.ts";
import Migration0031 from "./Migrations/031_CleanupStaleProviderDiffPlaceholders.ts";
...
export const migrationEntries = [
  ...
  [30, "ProjectionTurnsCheckpointCaptureState", Migration0030],
  [31, "CleanupStaleProviderDiffPlaceholders", Migration0031],
] as const;
