  ...
  switch (event.type) {
    case "project.created": {
      ...
      const nextProject = mapProject({
        ...
        defaultExecutionEnvironmentPreference: event.payload.defaultExecutionEnvironmentPreference,
    ...
    case "project.meta-updated": {
      const projects = updateProject(state.projects, event.payload.projectId, (project) => ({
        ...
        ...(event.payload.defaultModelSelection !== undefined
          ...
          : {}),
        ...(event.payload.defaultExecutionEnvironmentPreference !== undefined
          ? {
              defaultExecutionEnvironmentPreference:
                event.payload.defaultExecutionEnvironmentPreference,
            }
          : {}),
    ...
    case "thread.created": {
      ...
      const nextThread = mapThread({
        ...
        executionEnvironmentPreference: event.payload.executionEnvironmentPreference,
...
/* trailing bytes removed after Windows in-place edit */
